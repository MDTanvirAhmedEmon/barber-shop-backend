...
router.get('/get-barber-appointment', auth(ENUM_USER_ROLE.BARBER), appointmentController.getBarberAppointment)
router.get('/', auth(ENUM_USER_ROLE.SUPER_ADMIN, ENUM_USER_ROLE.ADMIN), appointmentController.getAllAppointment)
router.patch('/:id', auth(ENUM_USER_ROLE.SUPER_ADMIN, ENUM_USER_ROLE.ADMIN, ENUM_USER_ROLE.BARBER), appointmentController.updateAppointment)
